...
@section('content')
    @component('components.breadcrumb')
        ...
        <li class="breadcrumb-item"><a href="{{ route('categories.index') }}">الموظفين</a></li>
    ...
    <div class="container-fluid">
        <div class="category-profile">
            <div class="row">
                <!-- category profile header start-->
                <div class="col-sm-12">
                    <div class="card profile-header">
                        <img class="img-fluid bg-img-cover" src="{{ asset('assets/images/category-profile/bg-profile.jpg') }}"
                            alt="" />
                        <div class="profile-img-wrrap"><img class="img-fluid bg-img-cover"
                                src="{{ asset('assets/images/category-profile/bg-profile.jpg') }}" alt="" /></div>
                        <div class="categorypro-box">
                            <div class="img-wrraper">
                                <div class="avatar"><img class="img-fluid" alt=""
                                        src="{{ asset('assets/images/category/7.jpg') }}" /></div>
                                <a class="icon-wrapper" href="{{ route('categories.edit', $category->id) }}"><i class="icofont icofont-pencil-alt-5"></i></a>
                            </div>
                            <div class="category-designation">
                                <div class="title">
                                    {{-- <a target="_blank" href=""> --}}
                                        <h4>{{ $category->name }}</h4>
                                        <h6>{{ $category->roles_name }}</h6>
                                    {{-- </a> --}}
                                </div>
                                {{-- <div class="social-media">
                                    <ul class="category-list-social">
                                        <li>
                ...
                <!-- category profile fifth-style end-->
